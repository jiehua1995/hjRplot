...
ali_selected <- subset(ali, tname == "chr3R_mel")
ali_selected <- subset(ali_selected, qname == "chr3R_sim")
ali_selected <- subset(ali_selected, mapq >= 60)
...
paf_selected_coverage(ali_selected, chr="chr3R_mel", mapping_type="P")
